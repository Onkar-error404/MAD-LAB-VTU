...
int mode=0; @Override
protected void onCreate(Bundle savedInstanceState) { super.onCreate(savedInstanceState); setContentView(R.layout.activity_view); lblData=(TextView)findViewById(R.id.lbl_data); mode=getIntent().getIntExtra("mode",0);
