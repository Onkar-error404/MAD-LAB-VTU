...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener { EditText txtLoginUsername;
EditText txtLoginPassword;
Button btnLogin; String user,pass; int count=0;
@Override
...
Bundle bundle=getIntent().getBundleExtra("data"); user=bundle.getString("user"); pass=bundle.getString("pass");
}
public void onClick(View v)
{
String user1=txtLoginUsername.getText().toString(); String pass1=txtLoginPassword.getText().toString();
...
count++; if(count==2)
{
btnLogin.setEnabled(false); Toast.makeText(this,
