...
Button btnDel,btnStar,btnHash,btnCall,btnSave; EditText txtPhonenumber;
@Override
...
"Unknown"); contactIntent.putExtra(ContactsContract.Intents.Insert.PHONE,
txtPhonenumber.getText().toString()); startActivity(contactIntent);
}
else if(v.equals(btnCall))
{
String data=txtPhonenumber.getText().toString(); Intent it=new Intent(Intent.ACTION_CALL); it.setData(Uri.parse("tel:"+data)); startActivity(it);
